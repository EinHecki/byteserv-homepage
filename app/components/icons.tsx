/**
 * SVG Icon Components
 * Lightweight, inline SVG icons for better performance and customization
 */
...
export function IconPOS({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRestaurant({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M7 2v20" />
      <path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3v0a5 5 0 0 0 0-10Z" />
    </svg>
  );
}
...
export function IconHandshake({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M7 18h1c.6 0 1.1-.2 1.4-.6L12 14" />
      <path d="M8 12l-3-3" />
      <path d="M16 12l3-3" />
      <path d="M13 18h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L9 20" />
    </svg>
  );
}
